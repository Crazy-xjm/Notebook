...
![windows](D:\Typora\assets\windows.png)
...
![linux](D:\Typora\assets\linux.png)

#### 1.2.4. Mac OS

苹果自家的操作系统，编程体验和 Linux 相当，但是界面、软件生态以及用户体验各方面都要比 Linux 操作系统更好。

![macos](D:\Typora\assets\macos.png)
...
![Linux](D:\Typora\assets\Linux之父.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](D:\Typora\assets\Linux-Logo.png)
...
![文件inode信息](D:\Typora\assets\文件inode信息.png)
...
![Linux的目录结构](D:\Typora\assets\Linux目录树.png)
...
![](D:\Typora\assets\Linux权限命令.png)

第一列的内容的信息解释如下：

![](D:\Typora\assets\Linux权限解读.png)
